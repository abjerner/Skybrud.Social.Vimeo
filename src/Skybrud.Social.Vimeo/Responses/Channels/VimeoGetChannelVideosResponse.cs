...
namespace Skybrud.Social.Vimeo.Responses.Channels {
    ...
    public class VimeoGetChannelVideosResponse : VimeoResponse<VimeoVideosCollection> {
        ...
        private VimeoGetChannelVideosResponse(IHttpResponse response) : base(response) {
        ...
        public static VimeoGetChannelVideosResponse ParseResponse(IHttpResponse response) {
