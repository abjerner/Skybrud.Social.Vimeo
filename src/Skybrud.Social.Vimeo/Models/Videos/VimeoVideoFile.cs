...
public class VimeoVideoFile : VimeoObject {
    ...
    /// <summary>
    /// Gets the MIME type of the video file - e.g. <c>video/mp4</c>.
    /// </summary>
    ...
    /// <summary>
    /// Gets the public name of the quality of the file - e.g. <c>HD 1080p</c>.
    /// </summary>
    public string PublicName { get; }

    /// <summary>
    /// Gets the video file's size in a more readable way - e.g. <c>32.18MB</c>.
    /// </summary>
